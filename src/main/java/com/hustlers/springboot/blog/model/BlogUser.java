...
//    Error message will pop us stating that the Full Name, Username, and Password must be a certain length
    ...
    @Size(min = 4, max = 30, message = "Username should be a minimum of 4 characters")
    private String username;

    @NotNull(message = "is required")
    @Size(min = 8, max = 50,message = "Password should be minimum of 8 character")
    ...
    @NotNull(message = "is required")
    @Size(min = 4, max = 50, message = "Full Name should be minimum of 4 characters")
